...
PAYMENT_NETWORK_ERROR_TEXT = "Похоже, сеть недоступна. Попробуй повторить чуть позже."
PAYMENT_API_ERROR_TEXT = "Сервис оплаты временно недоступен. Попробуй оплатить позже."
